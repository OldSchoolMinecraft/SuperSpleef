...
public class SetPos2 extends Command
{
	public SetPos2(String name, String desc, boolean adminOnly)
	{
		super("SetPos2", "Set second position for arena", true);
	}
	...
	public boolean run(CommandSender sender, String[] args)
	{
		...
		Util.setTempPos2(x, y, z);
		
		ss.sendSuccess(sender, String.format("Selected second position (x=%s,y=%s,z=%s)", x, y, z));
